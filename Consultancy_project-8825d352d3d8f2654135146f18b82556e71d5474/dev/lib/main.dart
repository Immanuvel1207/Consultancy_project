    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final response = await http.post(
          Uri.parse('https://consultancy-project-nse7.onrender.com/login'),
...
class _AdminPaymentApprovalScreenState extends State<AdminPaymentApprovalScreen> {
  ...
  try {
    final url = Uri.parse('https://consultancy-project-nse7.onrender.com/pending_transactions');
  ...
  Future<void> _approvePayment(String transactionId) async {
    try {
      final response = await http.post(
        Uri.parse('https://consultancy-project-nse7.onrender.com/approve_payment'),
        headers: {'Content-Type': 'application/json'},
  ...
  Future<void> _rejectPayment(String transactionId) async {
    try {
      final response = await http.post(
        Uri.parse('https://consultancy-project-nse7.onrender.com/reject_payment'),
        headers: {'Content-Type': 'application/json'},
        body: json.encode({'transactionId': transactionId}),
      );
...
class _AdminOperationsScreenState extends State<AdminOperationsScreen> {
  ...
  Future<void> _fetchVillages() async {
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/get_all_villages'),
      );
  ...
  Future<void> _searchByVillage() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/search_by_village?village=${_selectedVillage}'),
      );
  ...
  Future<void> _fetchInactiveCustomers() async {
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/inactive_customers'),
      );
  ...
  Future<void> _addUser() async {
    if (_formKey.currentState!.validate()) {
      try {
        final response = await http.post(
          Uri.parse('https://consultancy-project-nse7.onrender.com/add_user'),
          headers: {'Content-Type': 'application/json'},
          body: json.encode({
  ...
  Future<void> _fetchUserDetailsForDeletion() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/find_user?userId=${_userIdController.text}'),
      );
  ...
  Future<void> _deleteUser() async {
    try {
      final response = await http.delete(
        Uri.parse('https://consultancy-project-nse7.onrender.com/delete_user/${_userIdController.text}'),
      );
  ...
  Future<void> _viewAllUsers() async {
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/find_all_users'),
      );
  ...
  Future<void> _addPayment() async {
    if (_formKey.currentState!.validate()) {
      try {
        final response = await http.post(
          Uri.parse('https://consultancy-project-nse7.onrender.com/add_payments'),
          headers: {'Content-Type': 'application/json'},
          body: json.encode({
  ...
  Future<void> _viewPayments() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/find_payments?userIdPayments=${_userIdController.text}'),
      );
  ...
  Future<void> _viewPaymentsByMonth() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/view_payments_by_month?p_month=${_monthController.text}'),
      );
...
class _UserScreenState extends State<UserScreen> {
  ...
  Future<void> _fetchUserDetails() async {
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/find_user?userId=${widget.username}'),
      );
  ...
  Future<void> _fetchPayments() async {
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/find_payments?userIdPayments=${widget.username}'),
      );
  ...
  Future<void> _fetchNotifications() async {
    try {
      final response = await http.get(
        Uri.parse('https://consultancy-project-nse7.onrender.com/notifications/${widget.username}'),
      );
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> _checkPaymentStatus() async {
    try {
      final url = Uri.parse(
        'https://consultancy-project-nse7.onrender.com/check_payment_status?userId=${widget.username}&month=$_selectedMonth',
      );
  ...
  Future<void> _requestPayment() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://consultancy-project-nse7.onrender.com/request_payment'),
        headers: {'Content-Type': 'application/json'},
        body: json.encode({
